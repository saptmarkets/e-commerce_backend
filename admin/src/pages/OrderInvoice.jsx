...
import DeliveryTodoList from "@/components/delivery/DeliveryTodoList";
      ...
      >
        {!loading && (
          <div className="">
            <div className="flex lg:flex-row md:flex-row flex-col lg:items-center justify-between pb-4 border-b border-gray-50 dark:border-gray-700 dark:text-gray-300">
              ...
              <div className="lg:text-right text-left">
                <h2 className="lg:flex lg:justify-end text-lg font-serif font-semibold mt-4 lg:mt-0 lg:ml-0 md:mt-0">
                  {mode === "dark" ? (
                    <img src={logoDark} alt="saptmarkets" width="110" />
                  ) : (
                    <img src={logoLight} alt="saptmarkets" width="110" />
                  )}
                </h2>
            ...
            {/* Delivery Todo List for Processing/Out for Delivery Orders */}
            {data && (data.status === 'Processing' || data.status === 'Out for Delivery') && (
              <div className="mt-6 bg-blue-50 dark:bg-blue-900 p-6 rounded-lg">
            ...
            <div className="flex lg:flex-row md:flex-row flex-col justify-between">
              ...
              {data.loyaltyDiscount > 0 && (
                <div className="mb-3 md:mb-0 lg:mb-0  flex flex-col sm:flex-wrap">
                  ...
                  <span className="text-sm text-purple-600 dark:text-purple-400 font-semibold font-serif block">
                    -{currency}
                    {getNumberTwo(data.loyaltyDiscount)}
                  </span>
                  <span className="text-xs text-gray-500 dark:text-gray-400 block">
                    ({data.loyaltyPointsUsed} points used)
                  </span>
                </div>
              )}
