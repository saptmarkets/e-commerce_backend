    ...
    module.exports = function(t) {
      ...
      (function(t2) {
        ...
        function c(t3, e2, r2, n2) {
          ...
          return "undefined" != typeof ArrayBuffer && e2 instanceof ArrayBuffer ? function(t4, e3, r3, n3) {
            ...
            if ("string" == typeof r3 && "" !== r3 || (r3 = "utf8"), !u.isEncoding(r3)) throw new TypeError('"encoding" must be a valid string encoding');
            ...
            if (e3) {
              if ("undefined" != typeof ArrayBuffer && e3.buffer instanceof ArrayBuffer || "length" in e3) return "number" != typeof e3.length || function(t5) {
                return t5 != t5;
        ...
        function f(t3, e2) {
          if (l(e2), t3 = a(t3, e2 < 0 ? 0 : 0 | p(e2)), !u.TYPED_ARRAY_SUPPORT) for (var r2 = 0; r2 < e2; ++r2) t3[r2] = 0;
          return t3;
        }
        function h(t3, e2) {
        ...
        function v(t3, e2, r2, n2, i2) {
          ...
          if ("string" == typeof e2 && (e2 = u.from(e2, n2)), u.isBuffer(e2)) return 0 === e2.length ? -1 : y(t3, e2, r2, n2, i2);
          if ("number" == typeof e2) return e2 &= 255, u.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? i2 ? Uint8Array.prototype.indexOf.call(t3, e2, r2) : Uint8Array.prototype.lastIndexOf.call(t3, e2, r2) : y(t3, [e2], r2, n2, i2);
        ...
        function C(t3, e2, r2, n2) {
          return V(function(t4, e3) {
            for (var r3, n3, i2, o2 = [], s2 = 0; s2 < t4.length && !((e3 -= 2) < 0); ++s2) n3 = (r3 = t4.charCodeAt(s2)) >> 8, i2 = r3 % 256, o2.push(i2), o2.push(n3);
            return o2;
        ...
        function j(t3, e2, r2) {
          ...
          return function(t4) {
            var e3 = t4.length;
            if (e3 <= S) return String.fromCharCode.apply(String, t4);
            for (var r3 = "", n3 = 0; n3 < e3; ) r3 += String.fromCharCode.apply(String, t4.slice(n3, n3 += S));
            return r3;
          }(n2);
        }
        e.Buffer = u, e.SlowBuffer = function(t3) {
          ...
          for (var e2 = 0; e2 < t3; e2 += 2) _(this, e2, e2 + 1);
          return this;
        }, u.prototype.swap32 = function() {
          var t3 = this.length;
          if (t3 % 4 != 0) throw new RangeError("Buffer size must be a multiple of 32-bits");
          for (var e2 = 0; e2 < t3; e2 += 4) _(this, e2, e2 + 3), _(this, e2 + 1, e2 + 2);
          return this;
        }, u.prototype.swap64 = function() {
          var t3 = this.length;
          if (t3 % 8 != 0) throw new RangeError("Buffer size must be a multiple of 64-bits");
          for (var e2 = 0; e2 < t3; e2 += 8) _(this, e2, e2 + 7), _(this, e2 + 1, e2 + 6), _(this, e2 + 2, e2 + 5), _(this, e2 + 3, e2 + 4);
          return this;
          ...
          for (var o2 = i2 - n2, s2 = r2 - e2, a2 = Math.min(o2, s2), c2 = this.slice(n2, i2), l2 = t3.slice(e2, r2), f2 = 0; f2 < a2; ++f2) if (c2[f2] !== l2[f2]) {
            o2 = c2[f2], s2 = l2[f2];
            break;
          }
        ...
        u.prototype.slice = function(t3, e2) {
          ...
          if (t3 = ~~t3, e2 = void 0 === e2 ? n2 : ~~e2, t3 < 0 ? (t3 += n2) < 0 && (t3 = 0) : t3 > n2 && (t3 = n2), e2 < 0 ? (e2 += n2) < 0 && (e2 = 0) : e2 > n2 && (e2 = n2), e2 < t3 && (e2 = t3), u.TYPED_ARRAY_SUPPORT) (r2 = this.subarray(t3, e2)).__proto__ = u.prototype;
          else {
            var i2 = e2 - t3;
            r2 = new u(i2, void 0);
      ...
      t.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function(t2) {
        if (!/* @__PURE__ */ function(t3) {
          return "number" == typeof t3;
        }(t2) || t2 < 0 || isNaN(t2)) throw TypeError("n must be a positive number");
        ...
        if (this._events || (this._events = {}), "error" === t2 && (!this._events.error || i(this._events.error) && !this._events.error.length)) {
          if ((e2 = arguments[1]) instanceof Error) throw e2;
          var l = new Error('Uncaught, unspecified "error" event. (' + e2 + ")");
          throw l.context = e2, l;
        }
        if (o(r2 = this._events[t2])) return false;
        if (n(r2)) switch (arguments.length) {
          case 1:
            r2.call(this);
            break;
          case 2:
        ...
        else if (i(r2)) for (a = Array.prototype.slice.call(arguments, 1), s = (c = r2.slice()).length, u = 0; u < s; u++) c[u].apply(this, a);
        return true;
        ...
        if (s = (r2 = this._events[t2]).length, o2 = -1, r2 === e2 || n(r2.listener) && r2.listener === e2) delete this._events[t2], this._events.removeListener && this.emit("removeListener", t2, e2);
        else if (i(r2)) {
          for (a = s; a-- > 0; ) if (r2[a] === e2 || r2[a].listener && r2[a].listener === e2) {
            o2 = a;
            break;
          }
          if (o2 < 0) return this;
        ...
        if (n(r2 = this._events[t2])) this.removeListener(t2, r2);
        else if (r2) for (; r2.length; ) this.removeListener(t2, r2[r2.length - 1]);
      ...
      (function(e2, n, i) {
        ...
        function m(t2) {
          if (a = a || r(1), !(l.call(m, this) || this instanceof a)) return new m(t2);
        ...
        function w(t2, e3) {
          ...
          if (t2._writev && r2 && r2.next) {
            ...
            for (; r2; ) {
              ...
              if (g(t2, e3, false, e3.objectMode ? 1 : c2.length, c2, l2, f2), r2 = r2.next, e3.bufferedRequestCount--, e3.writing) break;
            }
        ...
        c.inherits(m, h), y.prototype.getBuffer = function() {
          ...
          return s2 && !p.isBuffer(t2) && (t2 = function(t3) {
            ...
            } else g(t3, e4, false, a2, n3, i3, o2);
            return u2;
      ...
      (function(e2, r2, n) {
        t.exports = function t2(e3, r3, n2) {
          ...
          for (var o = "function" == typeof _dereq_ && _dereq_, s = 0; s < n2.length; s++) i(n2[s]);
          return i;
        }({ 1: [function(t2, e3, r3) {
          "use strict";
          ...
          e3.exports = function(e4, r4, n2, i) {
            ...
            e4.prototype.break = e4.prototype.cancel = function() {
              ...
              if (o.isArray(t3)) for (var r5 = 0; r5 < t3.length; ++r5) this._doInvokeOnCancel(t3[r5], e5);
          ...
          r3.exports = function(r4, n3) {
            ...
            function T(t3, e3, r5) {
              ...
              try {
                t3(e3, r5, function(t4) {
                  if ("function" != typeof t4) throw new TypeError("onCancel must be a function, got: " + l.toString(t4));
            ...
            function I(t3, e3) {
              if (f(t3)) {
                var r5 = this._trace;
                if (void 0 !== r5 && e3 && (r5 = r5._parent), void 0 !== r5) r5.attachExtraTrace(t3);
            ...
            function U(t3, e3, n4) {
              if (J.warnings) {
                var i2, o2 = new c(t3);
                if (e3) n4._attachExtraTrace(o2);
                else if (J.longStackTraces && (i2 = r4._peekContext())) i2.attachExtraTrace(o2);
                else {
                  var s2 = H(o2);
                  o2.stack = s2.message + "\n" + s2.stack.join("\n");
                }
            ...
            function H(t3) {
              ...
              return e3 = "string" == typeof e3 && e3.length > 0 ? function(t4) {
                for (var e4 = t4.stack.replace(/\s+$/g, "").split("\n"), r6 = 0; r6 < e4.length; ++r6) {
                  var n4 = e4[r6];
                  if ("    (No stack trace)" === n4 || _.test(n4)) break;
                }
            ...
            function W(t3) {
              var e3;
              if ("function" == typeof t3) e3 = "[function " + (t3.name || "anonymous") + "]";
              else {
                if (e3 = t3 && "function" == typeof t3.toString ? t3.toString() : l.toString(t3), /\[object [a-zA-Z0-9$_]+\]/.test(e3)) try {
            ...
            function Q(t3) {
              var e3 = t3.match(z);
              if (e3) return { fileName: e3[1], line: parseInt(e3[2], 10) };
            }
            function X(t3) {
            ...
            l.inherits(X, Error), n3.CapturedTrace = X, X.prototype.uncycle = function() {
              var t3 = this._length;
              if (!(t3 < 2)) {
                for (var e3 = [], r5 = {}, n4 = 0, i2 = this; void 0 !== i2; ++n4) e3.push(i2), i2 = i2._parent;
                ...
                for (n4 = 0; n4 < t3; ++n4) {
                  ...
                  if (void 0 !== s2 && s2 !== n4) {
                    ...
                    for (var u2 = a2._length + 1, c2 = n4 - 2; c2 >= 0; --c2) e3[c2]._length = u2, u2++;
                    return;
                  }
                }
              }
              ...
              if (!t3.__stackCleaned__) {
                this.uncycle();
                for (var e3 = H(t3), r5 = e3.message, n4 = [e3.stack], i2 = this; void 0 !== i2; ) n4.push(N(i2.stack.split("\n"))), i2 = i2._parent;
                !function(t4) {
                  for (var e4 = t4[0], r6 = 1; r6 < t4.length; ++r6) {
                    for (var n5 = t4[r6], i3 = e4.length - 1, o2 = e4[i3], s2 = -1, a2 = n5.length - 1; a2 >= 0; --a2) if (n5[a2] === o2) {
                      s2 = a2;
                      break;
                    }
                    for (a2 = s2; a2 >= 0; --a2) {
                  ...
                  for (var e4 = 0; e4 < t4.length; ++e4) (0 === t4[e4].length || e4 + 1 < t4.length && t4[e4][0] === t4[e4 + 1][0]) && (t4.splice(e4, 1), e4--);
                }(n4), l.notEnumerableProp(t3, "stack", function(t4, e4) {
                  for (var r6 = 0; r6 < e4.length - 1; ++r6) e4[r6].push("From previous event:"), e4[r6] = e4[r6].join("\n");
            ...
            var G = function() {
              ...
              var n4, i2 = new Error();
              if ("string" == typeof i2.stack && i2.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return _ = /@/, v = e3, y = true, function(t4) {
            ...
            return b && r4.longStackTraces(), { longStackTraces: function() {
              ...
              if (void 0 === t3 && null !== e3 && w) {
                if (void 0 !== i2 && i2._returnedNonUndefined()) return;
                if (0 == (65535 & n4._bitField)) return;
                r5 && (r5 += " ");
                var o2 = "", s2 = "";
                if (e3._trace) {
                  ...
                  if (u2.length > 0) {
                    var h2 = u2[0];
                    for (c2 = 0; c2 < a2.length; ++c2) if (a2[c2] === h2) {
                      c2 > 0 && (s2 = "\n" + a2[c2 - 1]);
                      break;
                    }
                  }
              ...
              if (Y()) {
                for (var r5, n4, i2 = t3.stack.split("\n"), o2 = e3.stack.split("\n"), s2 = -1, a2 = -1, u2 = 0; u2 < i2.length; ++u2) if (c2 = Q(i2[u2])) {
          ...
          e3.exports = function(t3) {
            ...
            t3.prototype.return = t3.prototype.thenReturn = function(r5) {
              ...
              if (arguments.length <= 1) return this._then(void 0, r4, void 0, { reason: t4 }, void 0);
              var e5 = arguments[1];
              return this.caught(t4, function() {
                throw e5;
              });
            }, t3.prototype.catchReturn = function(r5) {
              if (arguments.length <= 1) return r5 instanceof t3 && r5.suppressUnhandledRejections(), this._then(void 0, e4, void 0, { value: r5 }, void 0);
              var n2 = arguments[1];
          ...
          function l(t3, e4) {
            function r4(n3) {
              if (!(this instanceof r4)) return new r4(n3);
          ...
          if (n2) e3.exports = { freeze: Object.freeze, defineProperty: Object.defineProperty, getDescriptor: Object.getOwnPropertyDescriptor, keys: Object.keys, names: Object.getOwnPropertyNames, getPrototypeOf: Object.getPrototypeOf, isArray: Array.isArray, isES5: n2, propertyIsWritable: function(t3, e4) {
            ...
            var i = {}.hasOwnProperty, o = {}.toString, s = {}.constructor.prototype, a = function(t3) {
              var e4 = [];
              for (var r4 in t3) i.call(t3, r4) && e4.push(r4);
              return e4;
            };
          ...
          e3.exports = function(e4, r4, n2) {
            ...
            return u.prototype.isFinallyHandler = function() {
              ...
              if (1 === r5) return this._passThrough(t3, 1, void 0, p);
              var n3, o2 = new Array(r5 - 1), s2 = 0;
              for (n3 = 0; n3 < r5 - 1; ++n3) {
                var u2 = arguments[n3];
                if (!i.isObject(u2)) return e4.reject(new TypeError("tapCatch statement predicate: expecting an object but got " + i.classString(u2)));
                o2[s2++] = u2;
              }
              o2.length = s2;
              var c2 = arguments[n3];
          ...
          e3.exports = function(e4, r4, n2, i, o, s) {
            ...
            function h(t3, r5, i2, o2) {
              ...
              } else (this._promise = new e4(n2))._captureStackTrace();
            ...
            u.inherits(h, o), h.prototype._isResolved = function() {
              ...
              if (!this._isResolved()) {
                var t3;
                if (void 0 !== this._generator.return) this._promise._pushContext(), t3 = l(this._generator.return).call(this._generator, void 0), this._promise._popContext();
                else {
              ...
              if (t3 === c) return this._cleanup(), this._cancellationPhase ? r5.cancel() : r5._rejectCallback(t3.e, false);
              var n3 = t3.value;
              if (true === t3.done) return this._cleanup(), this._cancellationPhase ? r5.cancel() : r5._resolveCallback(n3);
              ...
              if ("function" != typeof t3) throw new a("generatorFunction must be a function\n\n    See http://goo.gl/MqrFmX\n");
              ...
              if ("function" != typeof t3) throw new a("expecting a function but got " + u.classString(t3));
              f.push(t3);
            }, e4.spawn = function(t3) {
              if (s.deprecated("Promise.spawn()", "Promise.coroutine()"), "function" != typeof t3) return r4("generatorFunction must be a function\n\n    See http://goo.gl/MqrFmX\n");
          ...
          e3.exports = function(e4, r4, n2, i, o, s) {
            ...
            function p(t3, r5, i2, o2) {
              if ("function" != typeof r5) return n2("expecting a function but got " + u.classString(r5));
              var s2 = 0;
              if (void 0 !== i2) {
                if ("object" != typeof i2 || null === i2) return e4.reject(new TypeError("options argument must be an object but it is " + u.classString(i2)));
                if ("number" != typeof i2.concurrency) return e4.reject(new TypeError("'concurrency' must be a number but it is " + u.classString(i2.concurrency)));
                s2 = i2.concurrency;
              }
            ...
            u.inherits(h, r4), h.prototype._asyncInit = function() {
              ...
              if (r5 < 0) {
                if (n3[r5 = -1 * r5 - 1] = t3, u2 >= 1 && (this._inFlight--, this._drainQueue(), this._isResolved())) return true;
              } else {
                if (u2 >= 1 && this._inFlight >= u2) return n3[r5] = t3, this._queue.push(r5), false;
                null !== a2 && (a2[r5] = t3);
                var f2 = this._promise, h2 = this._callback, p2 = f2._boundValue();
                f2._pushContext();
                var d = c(h2).call(p2, t3, r5, o2), _ = f2._popContext();
                if (s.checkForgottenReturns(d, _, null !== a2 ? "Promise.filter" : "Promise.map", f2), d === l) return this._reject(d.e), true;
                var v = i(d, this._promise);
                if (v instanceof e4) {
                  var y = (v = v._target())._bitField;
                  if (0 == (50397184 & y)) return u2 >= 1 && this._inFlight++, n3[r5] = v, v._proxy(this, -1 * (r5 + 1)), false;
                  if (0 == (33554432 & y)) return 0 != (16777216 & y) ? (this._reject(v._reason()), true) : (this._cancel(), true);
                  d = v._value();
                }
                n3[r5] = d;
              }
              ...
              for (var r5 = e5.length, n3 = new Array(r5), i2 = 0, o2 = 0; o2 < r5; ++o2) t3[o2] && (n3[i2++] = e5[o2]);
          ...
          e3.exports = function(e4, r4, n2, i, o) {
            ...
            e4.method = function(t3) {
              if ("function" != typeof t3) throw new e4.TypeError("expecting a function but got " + s.classString(t3));
              return function() {
                var n3 = new e4(r4);
              ...
              if ("function" != typeof t3) return i("expecting a function but got " + s.classString(t3));
              var n3, u = new e4(r4);
          ...
          e3.exports = function(e4) {
            ...
            function s(t3, e5) {
              if (!r4.isArray(t3)) return a.call(this, t3, e5);
          ...
          r3.exports = function() {
            ...
            function T(t3) {
              t3 !== v && function(t4, e3) {
                if (null == t4 || t4.constructor !== T) throw new d("the promise constructor cannot be invoked directly\n\n    See http://goo.gl/MqrFmX\n");
                if ("function" != typeof e3) throw new d("expecting a function but got " + c.classString(e3));
            ...
            return T.prototype.toString = function() {
              ...
              if (e3 > 1) {
                ...
                for (r4 = 0; r4 < e3 - 1; ++r4) {
                  var s2 = arguments[r4];
                  if (!c.isObject(s2)) return o("Catch statement predicate: expecting an object but got " + c.classString(s2));
                  n4[i2++] = s2;
                }
              ...
              if ("function" != typeof t3) throw new d("expecting a function but got " + c.classString(t3));
              ...
              } else u2._addCallbacks(t3, e3, s2, n4, f2);
              return s2;
              ...
              if (e3 !== u) return void 0 === e3 && this._isBound() ? this._boundValue() : e3;
              ...
              var o2 = this._length();
              if (o2 >= 65531 && (o2 = 0, this._setLength(0)), 0 === o2) this._promise0 = r4, this._receiver0 = n4, "function" == typeof t3 && (this._fulfillmentHandler0 = null === i2 ? t3 : c.domainBind(i2, t3)), "function" == typeof e3 && (this._rejectionHandler0 = null === i2 ? e3 : c.domainBind(i2, e3));
              else {
                var s2 = 4 * o2 - 4;
              ...
              if (0 == (117506048 & this._bitField)) {
                if (t3 === this) return this._rejectCallback(n3(), false);
                var r4 = g(t3, this);
                if (!(r4 instanceof T)) return this._fulfill(t3);
                ...
                if (i2 !== this) {
                  ...
                  if (0 == (50397184 & o2)) {
                    ...
                    for (var a2 = 1; a2 < s2; ++a2) i2._migrateCallbackAt(this, a2);
                    this._setFollowing(), this._setLength(0), this._setFollowee(i2);
                  } else if (0 != (33554432 & o2)) this._fulfill(i2._value());
                  else if (0 != (16777216 & o2)) this._reject(i2._reason());
                  else {
                    var u2 = new _("late cancellation observer");
                    i2._attachExtraTrace(u2), this._reject(u2);
                  }
                } else this._reject(n3());
              }
          ...
          e3.exports = function(e4, r4, n2, i, o) {
            ...
            return s.isArray, s.inherits(a, o), a.prototype.length = function() {
              ...
              if (a2 instanceof e4) {
                ...
                if (this._values = a2, 0 == (50397184 & u)) return this._promise._setAsyncGuaranteed(), a2._then(t3, this._reject, void 0, this, o2);
                if (0 == (33554432 & u)) return 0 != (16777216 & u) ? this._reject(a2._reason()) : this._cancel();
                a2 = a2._value();
              }
              if (null !== (a2 = s.asArray(a2))) 0 !== a2.length ? this._iterate(a2) : -5 === o2 ? this._resolveEmptyArray() : this._resolve(function(t4) {
                switch (o2) {
                  case -2:
                    return [];
                  case -3:
              ...
              if (!this._isResolved()) {
                var t3 = this._values;
                if (this._cancel(), t3 instanceof e4) t3.cancel();
                else for (var r5 = 0; r5 < t3.length; ++r5) t3[r5] instanceof e4 && t3[r5].cancel();
              }
          ...
          e3.exports = function(e4, r4) {
            ...
            function v(t3, e5, r5, n3) {
              ...
              return function(t4, e6, r6) {
                for (var n4 = 0; n4 < t4.length; n4 += 2) {
                  var i2 = t4[n4];
                  if (r6.test(i2)) {
                    for (var o3 = i2.replace(r6, ""), s3 = 0; s3 < t4.length; s3 += 2) if (t4[s3] === o3) throw new c("Cannot promisify an API that has normal methods with '%s'-suffix\n\n    See http://goo.gl/MqrFmX\n".replace("%s", e6));
                  }
                }
              }(s2, e5, r5), s2;
            }
            ...
            function g(t3, e5, r5, o2, s2) {
              for (var a2 = new RegExp(y(e5) + "$"), u2 = v(t3, e5, a2, r5), c2 = 0, l2 = u2.length; c2 < l2; c2 += 2) {
                ...
                if (o2 === m) t3[p2] = m(f2, n2, f2, h2, e5, s2);
                else {
            ...
            e4.promisify = function(t3, e5) {
              if ("function" != typeof t3) throw new c("expecting a function but got " + i.classString(t3));
              if (d(t3)) return t3;
              ...
              if ("function" != typeof t3 && "object" != typeof t3) throw new c("the target of promisifyAll must be an object or a function\n\n    See http://goo.gl/MqrFmX\n");
              var r5 = !!(e5 = Object(e5)).multiArgs, n3 = e5.suffix;
              "string" != typeof n3 && (n3 = "Async");
              var o2 = e5.filter;
              "function" != typeof o2 && (o2 = h);
              var s2 = e5.promisifier;
              if ("function" != typeof s2 && (s2 = m), !i.isIdentifier(n3)) throw new RangeError("suffix must be a valid identifier\n\n    See http://goo.gl/MqrFmX\n");
          ...
          e3.exports = function(e4, r4, n2, i) {
            ...
            function l(t3) {
              var e5, r5 = false;
              if (void 0 !== o && t3 instanceof o) e5 = c(t3), r5 = true;
              else {
            ...
            s.inherits(l, r4), l.prototype._init = function() {
              ...
              if (this._values[e5] = t3, ++this._totalResolved >= this._length) {
                ...
                if (this._isMap) r5 = function(t4) {
                  ...
                  r5 = {};
                  for (var n3 = this.length(), i2 = 0, s2 = this.length(); i2 < s2; ++i2) r5[this._values[i2 + n3]] = this._values[i2];
                }
          ...
          n2.prototype._willBeOverCapacity = function(t3) {
            ...
            if (this._willBeOverCapacity(n3)) return this._pushOne(t3), this._pushOne(e4), void this._pushOne(r4);
            ...
            this._capacity = t3, function(t4, e5, r4, n3, i) {
              for (var o = 0; o < i; ++o) r4[o + n3] = t4[o + 0], t4[o + 0] = void 0;
          ...
          e3.exports = function(e4, r4, n2, i) {
            ...
            function a(t3, a2) {
              var u = n2(t3);
              if (u instanceof e4) return s(u);
              if (null === (t3 = o.asArray(t3))) return i("expecting an array or an iterable object but got " + o.classString(t3));
              var c = new e4(r4);
          ...
          e3.exports = function(e4, r4, n2, i, o, s) {
            ...
            u.inherits(l, r4), l.prototype._gotAccum = function(t3) {
              ...
              this._values = t3;
              var i2 = t3.length;
              if (void 0 !== this._initialValue ? (r5 = this._initialValue, n3 = 0) : (r5 = e4.resolve(t3[0]), n3 = 1), this._currentCancellable = r5, !r5.isRejected()) for (; n3 < i2; ++n3) {
          ...
          } else s = "undefined" == typeof MutationObserver || "undefined" != typeof window && window.navigator && (window.navigator.standalone || window.cordova) ? void 0 !== n ? function(t3) {
            n(t3);
          ...
          e3.exports = function(e4, r4, n2) {
            ...
            function l(t3, e5) {
              if ((0 | e5) !== e5 || e5 < 0) return n2("expecting a positive integer\n\n    See http://goo.gl/MqrFmX\n");
            ...
            i.inherits(c, r4), c.prototype._init = function() {
              ...
              if (this.howMany() > this._canPossiblyFulfill()) {
                for (var t3 = new s(), e5 = this.length(); e5 < this._values.length; ++e5) this._values[e5] !== u && t3.push(this._values[e5]);
          ...
          e3.exports = function(e4, r4) {
            ...
            return function(t3, a) {
              if (o(t3)) {
                ...
                if ("function" == typeof u) return function(t4) {
                  try {
          ...
          e3.exports = function(e4, r4, n2, i, o, s) {
            ...
            function d(t3, r5) {
              ...
              return function o2() {
                ...
                if (u2 instanceof e4 && u2._isDisposable()) {
                  ...
                  if (u2 instanceof e4) return u2._then(o2, p, null, null, null);
                }
                o2();
              }(), a2;
            }
            ...
            _.prototype.data = function() {
              ...
              if (t3 < 2) return r4("you must pass at least 2 arguments to Promise.using");
              var i2, o2 = arguments[t3 - 1];
              if ("function" != typeof o2) return r4("expecting a function but got " + a.classString(o2));
              var u2 = true;
              ...
              for (h2 = 0; h2 < b.length; ++h2) b[h2] = e4.resolve(c2[h2]).reflect();
              var w = e4.all(b).then(function(t4) {
                for (var e5 = 0; e5 < t4.length; ++e5) {
                  var r5 = t4[e5];
                  if (r5.isRejected()) return l.e = r5.error(), l;
                  if (!r5.isFulfilled()) return void w.cancel();
                  t4[e5] = r5.value();
                }
              ...
              if ("function" == typeof t3) return new v(t3, this, i());
              throw new u();
            };
          };
          ...
          var p = function() {
            var t3 = [Array.prototype, Object.prototype, Function.prototype], e3 = function(e4) {
              for (var r4 = 0; r4 < t3.length; ++r4) if (t3[r4] === e4) return true;
              return false;
            };
            if (s.isES5) {
            ...
            return function(r4) {
              if (e3(r4)) return [];
              var i2 = [];
              t: for (var o2 in r4) if (n3.call(r4, o2)) i2.push(o2);
              else {
                for (var s2 = 0; s2 < t3.length; ++s2) if (n3.call(t3[s2], o2)) continue t;
                i2.push(o2);
              }
              return i2;
            };
          ...
          if ("undefined" != typeof Symbol && Symbol.iterator) {
            var E = "function" == typeof Array.from ? function(t3) {
              ...
              for (var e3, r3 = [], n3 = t3[Symbol.iterator](); !(e3 = n3.next()).done; ) r3.push(e3.value);
              return r3;
            };
            w = function(t3) {
          ...
          var C = void 0 !== e2 && "[object process]" === b(e2).toLowerCase(), x = void 0 !== e2 && void 0 !== e2.env, j = { isClass: function(t3) {
            ...
            if (!s.isES5) return {}.hasOwnProperty.call(t3, e3) ? t3[e3] : void 0;
            ...
            function n3() {
              for (var n4 in this.constructor = t3, this.constructor$ = e3, e3.prototype) r3.call(e3.prototype, n4) && "$" !== n4.charAt(n4.length - 1) && (this[n4 + "$"] = e3.prototype[n4]);
            }
            ...
            e3.prototype = t3;
            for (var r3 = 8; r3--; ) new e3();
            return t3;
          }, filledRange: function(t3, e3, r3) {
            for (var n3 = new Array(t3), i2 = 0; i2 < t3; ++i2) n3[i2] = e3 + i2 + r3;
            return n3;
      ...
      Object.defineProperty(e, "__esModule", { value: true }), e.default = function(t2, e2) {
        if (!e2.eol && t2) {
          for (var r2 = 0, n = t2.length; r2 < n; r2++) if ("\r" === t2[r2]) {
            if ("\n" === t2[r2 + 1]) {
              e2.eol = "\r\n";
              break;
            }
      ...
      (function(e2, n) {
        ...
        function g(t2) {
          if (o = o || r(1), !(this instanceof g)) return new g(t2);
        ...
        function R(t2, e3) {
          for (var r2 = e3.length; !e3.reading && !e3.flowing && !e3.ended && e3.length < e3.highWaterMark && (p("maybeReadMore read 0"), t2.read(0), r2 !== e3.length); ) r2 = e3.length;
        ...
        g.prototype.read = function(t2) {
          ...
          if (0 !== t2 && (e3.emittedReadable = false), 0 === t2 && e3.needReadable && (e3.length >= e3.highWaterMark || e3.ended)) return p("read: emitReadable", e3.length, e3.ended), 0 === e3.length && e3.ended ? A(this) : x(this), null;
          if (0 === (t2 = C(t2, e3)) && e3.ended) return 0 === e3.length && A(this), null;
          ...
          if (1 === e3.pipesCount) return t2 && t2 !== e3.pipes ? this : (t2 || (t2 = e3.pipes), e3.pipes = null, e3.pipesCount = 0, e3.flowing = false, t2 && t2.emit("unpipe", this, r2), this);
          if (!t2) {
          ...
          for (var o2 = 0; o2 < y.length; o2++) t2.on(y[o2], this.emit.bind(this, y[o2]));
      ...
      function a(t2) {
        var e2 = this.lastTotal - this.lastNeed, r2 = function(t3, e3, r3) {
          if (128 != (192 & e3[0])) return t3.lastNeed = 0, "�";
          if (t3.lastNeed > 1 && e3.length > 1) {
            if (128 != (192 & e3[1])) return t3.lastNeed = 1, "�";
            if (t3.lastNeed > 2 && e3.length > 2 && 128 != (192 & e3[2])) return t3.lastNeed = 2, "�";
          }
        }(this, t2);
      ...
      (function(t2) {
        Object.defineProperty(e, "__esModule", { value: true }), e.bufFromString = function(e2) {
          ...
          for (var r2 = [], n = 0; n < t3.length; n++) e2.indexOf(n) > -1 && r2.push(t3[n]);
          return r2;
      ...
      var n = this && this.__extends || function() {
        var t2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t3, e2) {
          ...
          for (var r2 in e2) e2.hasOwnProperty(r2) && (t3[r2] = e2[r2]);
        };
      ...
      (function(t2) {
        var n = this && this.__extends || function() {
          var t3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t4, e2) {
            ...
            for (var r2 in e2) e2.hasOwnProperty(r2) && (t4[r2] = e2[r2]);
          };
          return function(e2, r2) {
            function n2() {
              this.constructor = e2;
        ...
        var o = r(36), s = r(50), a = r(51), u = i(r(15)), c = r(52), l = r(105), f = function(e2) {
          ...
          return n(i2, e2), i2.prototype.preRawData = function(t3) {
            ...
            return e3._read = function(e4) {
              if (r2 >= t3.length) this.push(null);
              else {
            ...
            this.processor.process(t3).then(function(t4) {
              if (t4.length > 0) return n2.runtime.started = true, n2.result.processResult(t4);
            }).then(function() {
              n2.emit("drained"), r2();
            }, function(t4) {
            ...
            this.processor.flush().then(function(t4) {
              if (t4.length > 0) return e3.result.processResult(t4);
            }).then(function() {
              e3.processEnd(t3);
            }, function(r2) {
              e3.emit("error", r2), t3();
      ...
      r(2)(i, n), i.Readable = r(13), i.Writable = r(46), i.Duplex = r(47), i.Transform = r(48), i.PassThrough = r(49), i.Stream = i, i.prototype.pipe = function(t2, e2) {
        ...
        function c(t3) {
          if (l(), 0 === n.listenerCount(this, "error")) throw t3;
        }
        function l() {
      ...
      e.byteLength = function(t2) {
        ...
        for (var e2, r2 = c(t2), n2 = r2[0], s2 = r2[1], a2 = new o(3 * (n2 + s2) / 4 - s2), u2 = 0, l2 = s2 > 0 ? n2 - 4 : n2, f2 = 0; f2 < l2; f2 += 4) e2 = i[t2.charCodeAt(f2)] << 18 | i[t2.charCodeAt(f2 + 1)] << 12 | i[t2.charCodeAt(f2 + 2)] << 6 | i[t2.charCodeAt(f2 + 3)], a2[u2++] = e2 >> 16 & 255, a2[u2++] = e2 >> 8 & 255, a2[u2++] = 255 & e2;
        ...
        for (var e2, r2 = t2.length, i2 = r2 % 3, o2 = [], s2 = 0, a2 = r2 - i2; s2 < a2; s2 += 16383) o2.push(f(t2, s2, s2 + 16383 > a2 ? a2 : s2 + 16383));
      ...
      function f(t2, e2, r2) {
        for (var n2, i2 = [], o2 = e2; o2 < r2; o2 += 3) n2 = (t2[o2] << 16 & 16711680) + (t2[o2 + 1] << 8 & 65280) + (255 & t2[o2 + 2]), i2.push(l(n2));
        return i2.join("");
      }
      ...
      t.exports = function() {
        ...
        return t2.prototype.push = function(t3) {
          ...
          for (var e2 = n.allocUnsafe(t3 >>> 0), r2 = this.head, i2 = 0; r2; ) o(r2.data, e2, i2), i2 += r2.data.length, r2 = r2.next;
          return e2;
        }, t2;
      ...
      Object.defineProperty(e, "__esModule", { value: true }), e.mergeParams = function(t2) {
        ...
        for (var r2 in t2 || (t2 = {}), t2) t2.hasOwnProperty(r2) && (Array.isArray(t2[r2]) ? e2[r2] = [].concat(t2[r2]) : e2[r2] = t2[r2]);
        return e2;
      };
    }, function(t, e, r) {
      "use strict";
        ...
        var o = r(53), s = i(r(15)), a = r(54), u = i(r(16)), c = r(57), l = r(28), f = r(58), h = i(r(59)), p = i(r(29)), d = function(e2) {
          ...
          return n(r2, e2), r2.prototype.flush = function() {
            ...
            if (this.params.noheader) this.params.headers ? this.runtime.headers = this.params.headers : this.runtime.headers = [];
              ...
              if (this.prependLeftBuf(l.bufFromString(e3)), 0 === r3.length) return [];
            ...
            if (this.runtime.selectedColumns = [], this.runtime.headers) {
              for (var t3 = this.runtime.headers, e3 = 0; e3 < t3.length; e3++) if (this.params.ignoreColumns) if (this.params.ignoreColumns.test(t3[e3])) {
                if (!this.params.includeColumns || !this.params.includeColumns.test(t3[e3])) continue;
                this.runtime.selectedColumns.push(e3);
              } else this.runtime.selectedColumns.push(e3);
              else this.params.includeColumns ? this.params.includeColumns.test(t3[e3]) && this.runtime.selectedColumns.push(e3) : this.runtime.selectedColumns.push(e3);
            ...
            if ("line" === this.params.output) return t3;
            ...
            return new s.default(function(r3, n2) {
              !function t4(e4, r4, n3, i2) {
                if (n3 >= e4.length) i2();
                  ...
                  if (n3++, s2 && s2.then) s2.then(function(o3) {
                    e4[n3 - 1] = o3, t4(e4, r4, n3, i2);
                  });
                  else {
                    for (e4[n3 - 1] = s2; n3 < e4.length; ) e4[n3] = r4.preFileLineHook(e4[n3], r4.parsedLineNumber + n3), n3++;
                    i2();
                  }
                } else i2();
      ...
      t.exports = function(t2) {
        for (var e2 = 0; e2 < t2.length; ) if (9 == t2[e2] || 10 == t2[e2] || 13 == t2[e2] || 32 <= t2[e2] && t2[e2] <= 126) e2 += 1;
        else if (194 <= t2[e2] && t2[e2] <= 223 && 128 <= t2[e2 + 1] && t2[e2 + 1] <= 191) e2 += 2;
        else if (224 == t2[e2] && 160 <= t2[e2 + 1] && t2[e2 + 1] <= 191 && 128 <= t2[e2 + 2] && t2[e2 + 2] <= 191 || (225 <= t2[e2] && t2[e2] <= 236 || 238 == t2[e2] || 239 == t2[e2]) && 128 <= t2[e2 + 1] && t2[e2 + 1] <= 191 && 128 <= t2[e2 + 2] && t2[e2 + 2] <= 191 || 237 == t2[e2] && 128 <= t2[e2 + 1] && t2[e2 + 1] <= 159 && 128 <= t2[e2 + 2] && t2[e2 + 2] <= 191) e2 += 3;
        else {
          if (!(240 == t2[e2] && 144 <= t2[e2 + 1] && t2[e2 + 1] <= 191 && 128 <= t2[e2 + 2] && t2[e2 + 2] <= 191 && 128 <= t2[e2 + 3] && t2[e2 + 3] <= 191 || 241 <= t2[e2] && t2[e2] <= 243 && 128 <= t2[e2 + 1] && t2[e2 + 1] <= 191 && 128 <= t2[e2 + 2] && t2[e2 + 2] <= 191 && 128 <= t2[e2 + 3] && t2[e2 + 3] <= 191 || 244 == t2[e2] && 128 <= t2[e2 + 1] && t2[e2 + 1] <= 143 && 128 <= t2[e2 + 2] && t2[e2 + 2] <= 191 && 128 <= t2[e2 + 3] && t2[e2 + 3] <= 191)) return false;
          e2 += 4;
        }
        return true;
      };
      ...
      var i = n(r(16)), o = r(28), s = [",", "|", "	", ";", ":"], a = function() {
        ...
        return Object.defineProperty(t2.prototype, "needEmitDelimiter", { get: function() {
          ...
          if (0 === t3.length || this.conv.parseParam.ignoreEmpty && 0 === t3.trim().length) return { cells: [], closed: true };
          ...
          if ("off" === e2) {
            if (r2) for (var o2 = 0; o2 < i2.length; o2++) i2[o2] = i2[o2].trim();
          ...
          for (var i2 = [], s2 = false, a2 = "", u = 0, c = t3.length; u < c; u++) {
            ...
            var f = l.length;
            if (s2) this.isQuoteClose(l) ? (s2 = false, a2 += n2 + (l = l.substr(0, f - 1)), a2 = this.escapeQuote(a2), e2 && (a2 = o.trimRight(a2)), i2.push(a2), a2 = "") : a2 += n2 + l;
            else {
          ...
          var e2;
          if ("auto" === this.conv.parseParam.delimiter) e2 = s;
          else {
          ...
          for (var n2 = 0, i2 = t3.length - 1; t3[i2] === e2 || t3[i2] === r2; ) i2--, n2++;
          return n2 % 2 != 0;
      ...
      function a(t2, e2, r2) {
        if (e2.parseParam.checkColumn && e2.parseRuntime.headers && t2.length !== e2.parseRuntime.headers.length) throw i.default.column_mismatched(e2.parseRuntime.parsedLineNumber + r2);
          ...
          for (var n2 = false, i2 = {}, o2 = 0, s2 = t3.length; o2 < s2; o2++) {
            ...
            if (!r3.parseParam.ignoreEmpty || "" !== a2) {
              ...
              if (f2) {
                ...
                if (r3.parseParam.checkType) a2 = p(a2, u2, o2, r3)(a2);
      ...
      function c(t2, e2, r2) {
        if (void 0 !== r2.parseRuntime.columnConv[e2]) return r2.parseRuntime.columnConv[e2];
        var n2 = r2.parseParam.colParser[t2];
        if (void 0 === n2) return r2.parseRuntime.columnConv[e2] = null;
      ...
      function l(t2, e2, r2, n2, i2) {
        if (!n2.parseRuntime.columnValueSetter[i2]) if (n2.parseParam.flatKeys) n2.parseRuntime.columnValueSetter[i2] = f;
        else if (e2.indexOf(".") > -1) {
          for (var o2 = e2.split("."), s2 = true; o2.length > 0; ) if (0 === o2.shift().length) {
            s2 = false;
            break;
          }
        ...
        } else n2.parseRuntime.columnValueSetter[i2] = f;
      ...
      t.exports = function t2(e2) {
        ...
        if (s(e2)) return u ? u.call(e2) : "";
        var r2 = e2 + "";
        return "0" == r2 && 1 / e2 == -1 / 0 ? "-0" : r2;
      };
    }, function(t, e) {
      t.exports = function(t2, e2) {
        for (var r = -1, n = null == t2 ? 0 : t2.length, i = Array(n); ++r < n; ) i[r] = e2(t2[r], r, t2);
        return i;
      };
    }, function(t, e) {
      var r = /^(?:0|[1-9]\d*)$/;
          ...
          return this.needPushDownstream && "array" === this.converter.parseParam.downstreamFormat && 0 === r2 && a(this.converter, "[" + o.EOL), new i.default(function(r3, n2) {
            e2.needEmitLine ? function t4(e3, r4, n3, i2, o2) {
              if (n3 >= e3.length) o2();
                ...
                if (n3++, c && c.then) c.then(function() {
                ...
                if (i2) for (; n3 < e3.length; ) l = e3[n3++], a(r4, l);
                o2();
              }
      ...
      function a(t2, e2) {
        if ("object" != typeof e2 || t2.options.objectMode) t2.push(e2);
        else {
