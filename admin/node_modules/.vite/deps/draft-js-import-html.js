import {
  require_immutable
} from "./chunk-FZZ2X3YX.js";
import {
  require_Draft
} from "./chunk-4B6VQNA5.js";
import "./chunk-R74LH37E.js";
...
var import_draft_js2 = __toESM(require_Draft());
...
var DATA_URL = /^data:/i;
var NO_STYLE = (0, import_immutable2.OrderedSet)();
var NO_ENTITY = null;
var EMPTY_BLOCK = new import_draft_js2.ContentBlock({
  key: (0, import_draft_js2.genKey)(),
  text: "",
  type: BLOCK_TYPE.UNSTYLED,
  characterList: (0, import_immutable2.List)(),
  depth: 0
});
var LINE_BREAKS = /(\r\n|\r|\n)/g;
...
var ContentGenerator = function() {
  function ContentGenerator2() {
    ...
    this.contentStateForEntities = import_draft_js2.ContentState.createFromBlockArray([]);
    this.blockStack = [];
    this.blockList = [];
    this.depth = 0;
  }
  _createClass2(ContentGenerator2, [{
    ...
    value: function process(element) {
      ...
      this.blockList.forEach(function(block) {
        ...
        if (text.length || includeEmptyBlock) {
          contentBlocks.push(new import_draft_js2.ContentBlock({
            key: (0, import_draft_js2.genKey)(),
            text,
            type: block.type,
            characterList: characterMeta.toList(),
            depth: block.depth,
            data: block.data ? (0, import_immutable2.Map)(block.data) : (0, import_immutable2.Map)()
          }));
        }
      });
      ...
      return import_draft_js2.ContentState.createFromBlockArray(contentBlocks, this.contentStateForEntities.getEntityMap());
    }
  }, {
    ...
    value: function processText(text) {
      ...
      var charMetadata = import_draft_js2.CharacterMetadata.create({
        style,
        entity
      });
      var seq = (0, import_immutable2.Repeat)(charMetadata, text.length);
...
function concatFragments(fragments) {
  var text = "";
  var characterMeta = (0, import_immutable2.Seq)();
