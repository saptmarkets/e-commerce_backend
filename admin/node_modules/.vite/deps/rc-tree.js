...
import {
  ...
  raf_default,
  require_classnames
} from "./chunk-F6KH6MC3.js";
import {
  _createSuper,
  _toConsumableArray
} from "./chunk-PDO26ZLF.js";
import {
  _objectWithoutProperties
} from "./chunk-S5KQUBR5.js";
import "./chunk-42DMEJ5H.js";
import "./chunk-EIBF7EAH.js";
import {
  _inherits
} from "./chunk-K42WVFET.js";
import {
  _classCallCheck
} from "./chunk-QQCM6MLG.js";
import {
  _objectSpread2
} from "./chunk-4KQ5QTQI.js";
import {
  _defineProperty
} from "./chunk-YCQRLYCC.js";
import {
  require_react_dom
} from "./chunk-R74LH37E.js";
import {
  _extends
} from "./chunk-KBUAZBQ3.js";
import "./chunk-YKHN2FTO.js";
import {
  _assertThisInitialized
} from "./chunk-TZHKOEH3.js";
import "./chunk-LMKMSGST.js";
import "./chunk-WJNNTF4C.js";
import {
  _createClass
} from "./chunk-CDH5E2TN.js";
import {
  _typeof
} from "./chunk-3V77IM33.js";
import {
  require_react
...
var ScrollBar = React12.forwardRef(function(props, ref) {
  var _classNames;
  ...
  var _React$useState = React12.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), dragging = _React$useState2[0], setDragging = _React$useState2[1];
  var _React$useState3 = React12.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), pageXY = _React$useState4[0], setPageXY = _React$useState4[1];
  var _React$useState5 = React12.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), startTop = _React$useState6[0], setStartTop = _React$useState6[1];
  var isLTR = !rtl;
  var scrollbarRef = React12.useRef();
  var thumbRef = React12.useRef();
  var _React$useState7 = React12.useState(false), _React$useState8 = _slicedToArray(_React$useState7, 2), visible = _React$useState8[0], setVisible = _React$useState8[1];
  var visibleTimeoutRef = React12.useRef();
  ...
  var top = React12.useMemo(function() {
  ...
  var enableScrollRangeRef = React12.useRef();
  enableScrollRangeRef.current = enableScrollRange;
  var enableOffsetRangeRef = React12.useRef();
  ...
  return React12.createElement("div", {
    ref: scrollbarRef,
    className: (0, import_classnames2.default)(scrollbarPrefixCls, (_classNames = {}, _defineProperty(_classNames, "".concat(scrollbarPrefixCls, "-horizontal"), horizontal), _defineProperty(_classNames, "".concat(scrollbarPrefixCls, "-vertical"), !horizontal), _defineProperty(_classNames, "".concat(scrollbarPrefixCls, "-visible"), visible), _classNames)),
...
function Item(_ref) {
  ...
  var refFunc = React13.useCallback(function(node) {
    setRef(node);
  }, []);
...
function useChildren(list, startIndex, endIndex, scrollWidth, setNodeRef, renderFunc, _ref) {
  ...
  return list.slice(startIndex, endIndex + 1).map(function(item, index2) {
    ...
    return React14.createElement(Item, {
      key,
...
function useHeights(getKey2, onItemAdd, onItemRemove) {
  var _React$useState = React15.useState(0), _React$useState2 = _slicedToArray(_React$useState, 2), updatedMark = _React$useState2[0], setUpdatedMark = _React$useState2[1];
...
function useScrollTo(containerRef, data, heights, itemHeight, getKey2, collectHeight, syncScrollTop, triggerFlash) {
  ...
  var _React$useState = React18.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), syncState = _React$useState2[0], setSyncState = _React$useState2[1];
...
function RawList(props, ref) {
  ...
  var getKey2 = React21.useCallback(function(item) {
  ...
  var horizontalScrollBarSpinSize = React21.useMemo(function() {
    return getSpinSize(size.width, scrollWidth);
  }, [size.width, scrollWidth]);
  var verticalScrollBarSpinSize = React21.useMemo(function() {
  ...
  return React21.createElement("div", _extends({
  ...
  }, containerProps, restProps), React21.createElement(es_default, {
    onResize: onHolderResize
  }, React21.createElement(Component6, {
    className: "".concat(prefixCls, "-holder"),
    style: componentStyle,
    ref: componentRef,
    onScroll: onFallbackScroll,
    onMouseEnter: delayHideScrollBar
  }, React21.createElement(Filler_default, {
    prefixCls,
    height: scrollHeight,
    offsetX: offsetLeft,
    offsetY: fillerOffset,
    ...
    rtl: isRTL,
    extra: extraContent
  }, listChildren))), inVirtual && scrollHeight > height && React21.createElement(ScrollBar_default, {
  ...
  }), inVirtual && scrollWidth && React21.createElement(ScrollBar_default, {
...
var List = React21.forwardRef(RawList);
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React28.forwardRef(function(props, ref) {
    ...
    if (!children) {
      ...
      motionChildren = children(_objectSpread2(_objectSpread2({}, mergedProps), {}, {
        className: (0, import_classnames4.default)(getTransitionName(motionName, status), (_classNames = {}, _defineProperty(_classNames, motionCls, motionCls && statusSuffix), _defineProperty(_classNames, motionName, typeof motionName === "string"), _classNames)),
        style: statusStyle
      }), setNodeRef);
    }
...
var Indent = function Indent2(_ref) {
  ...
  for (var i = 0; i < level; i += 1) {
    var _classNames;
    list.push(React30.createElement("span", {
      key: i,
      className: (0, import_classnames5.default)(baseClassName, (_classNames = {}, _defineProperty(_classNames, "".concat(baseClassName, "-start"), isStart[i]), _defineProperty(_classNames, "".concat(baseClassName, "-end"), isEnd[i]), _classNames))
    }));
  }
...
var Indent_default = React30.memo(Indent);
...
var InternalTreeNode = function(_React$Component) {
  ...
  function InternalTreeNode2() {
    ...
    _this.renderDragHandler = function() {
      ...
      return (draggable === null || draggable === void 0 ? void 0 : draggable.icon) ? React31.createElement("span", {
    ...
    _this.renderSwitcher = function() {
      ...
      if (_this.isLeaf()) {
        ...
        return _switcherIconDom !== false ? React31.createElement("span", {
          className: (0, import_classnames6.default)("".concat(prefixCls, "-switcher"), "".concat(prefixCls, "-switcher-noop"))
        }, _switcherIconDom) : null;
      }
      var switcherCls = (0, import_classnames6.default)("".concat(prefixCls, "-switcher"), "".concat(prefixCls, "-switcher_").concat(expanded ? ICON_OPEN : ICON_CLOSE));
      var switcherIconDom = _this.renderSwitcherIconDom(false);
      return switcherIconDom !== false ? React31.createElement("span", {
    ...
    _this.renderCheckbox = function() {
      ...
      return React31.createElement("span", {
        className: (0, import_classnames6.default)("".concat(prefixCls, "-checkbox"), checked && "".concat(prefixCls, "-checkbox-checked"), !checked && halfChecked && "".concat(prefixCls, "-checkbox-indeterminate"), (disabled || disableCheckbox) && "".concat(prefixCls, "-checkbox-disabled")),
    ...
    _this.renderIcon = function() {
      ...
      var prefixCls = _this.props.context.prefixCls;
      return React31.createElement("span", {
        className: (0, import_classnames6.default)("".concat(prefixCls, "-iconEle"), "".concat(prefixCls, "-icon__").concat(_this.getNodeState() || "docu"), loading && "".concat(prefixCls, "-icon_loading"))
      });
    };
    _this.renderSelector = function() {
      ...
      if (showIcon) {
        ...
        $icon = currentIcon ? React31.createElement("span", {
          className: (0, import_classnames6.default)("".concat(prefixCls, "-iconEle"), "".concat(prefixCls, "-icon__customize"))
      ...
      var $title = React31.createElement("span", {
        className: "".concat(prefixCls, "-title")
      }, titleNode);
      return React31.createElement("span", {
        ref: _this.setSelectHandle,
        title: typeof title === "string" ? title : "",
        className: (0, import_classnames6.default)("".concat(wrapClass), "".concat(wrapClass, "-").concat(_this.getNodeState() || "normal"), !disabled && (selected || dragNodeHighlight) && "".concat(prefixCls, "-node-selected")),
    ...
    value: (
      ...
      function render() {
        ...
        return React31.createElement("div", _extends({
          ...
          onMouseMove
        }, ariaSelected, dataOrAriaAttributeProps), React31.createElement(Indent_default, {
          prefixCls,
          level,
          isStart,
          isEnd
...
var ContextTreeNode = function ContextTreeNode2(props) {
  return React31.createElement(TreeContext.Consumer, null, function(context) {
    return React31.createElement(InternalTreeNode, _extends({}, props, {
      context
    }));
  });
};
...
function useUnmount(triggerStart, triggerEnd) {
  var _React$useState = React32.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), firstMount = _React$useState2[0], setFirstMount = _React$useState2[1];
  useLayoutEffect_default(function() {
    if (firstMount) {
      triggerStart();
      return function() {
...
var MotionTreeNode = function MotionTreeNode2(_ref, ref) {
  ...
  var _React$useState = React33.useState(true), _React$useState2 = _slicedToArray(_React$useState, 2), visible = _React$useState2[0], setVisible = _React$useState2[1];
  var _React$useContext = React33.useContext(TreeContext), prefixCls = _React$useContext.prefixCls;
  ...
  var triggerMotionEndRef = React33.useRef(false);
  ...
  if (motionNodes) {
    return React33.createElement(es_default3, _extends({
      ...
      return React33.createElement("div", {
        ...
        return React33.createElement(TreeNode_default, _extends({}, restProps, treeNodeProps, {
          title,
          active,
          data: treeNode.data,
          key,
  ...
  return React33.createElement(TreeNode_default, _extends({
    domRef: ref,
    className,
    style: style2
  }, props, {
...
var RefMotionTreeNode = React33.forwardRef(MotionTreeNode);
...
var NodeList = React34.forwardRef(function(props, ref) {
  ...
  var listRef = React34.useRef(null);
  var indentMeasurerRef = React34.useRef(null);
  ...
  var _React$useState = React34.useState(expandedKeys), _React$useState2 = _slicedToArray(_React$useState, 2), prevExpandedKeys = _React$useState2[0], setPrevExpandedKeys = _React$useState2[1];
  var _React$useState3 = React34.useState(data), _React$useState4 = _slicedToArray(_React$useState3, 2), prevData = _React$useState4[0], setPrevData = _React$useState4[1];
  var _React$useState5 = React34.useState(data), _React$useState6 = _slicedToArray(_React$useState5, 2), transitionData = _React$useState6[0], setTransitionData = _React$useState6[1];
  var _React$useState7 = React34.useState([]), _React$useState8 = _slicedToArray(_React$useState7, 2), transitionRange = _React$useState8[0], setTransitionRange = _React$useState8[1];
  var _React$useState9 = React34.useState(null), _React$useState10 = _slicedToArray(_React$useState9, 2), motionType = _React$useState10[0], setMotionType = _React$useState10[1];
  var dataRef = React34.useRef(data);
  ...
  return React34.createElement(React34.Fragment, null, focused && activeItem && React34.createElement("span", {
    style: HIDDEN_STYLE,
    "aria-live": "assertive"
  }, getAccessibilityPath(activeItem)), React34.createElement("div", null, React34.createElement("input", {
    style: HIDDEN_STYLE,
  ...
  }))), React34.createElement(es_default2, _extends({}, domProps, {
    data: mergedData,
    itemKey,
    height,
    fullHeight: false,
    ...
    return React34.createElement(MotionTreeNode_default, _extends({}, restProps, treeNodeProps, {
      title,
...
var Tree = function(_React$Component) {
  ...
  function Tree2() {
    ...
    _this.listRef = React36.createRef();
  ...
  _createClass(Tree2, [{
    ...
    value: function render() {
      ...
      return React36.createElement(TreeContext.Provider, {
        value: {
          prefixCls,
          selectable,
          showIcon,
        ...
        style: rootStyle
      }, React36.createElement(NodeList_default, _extends({
        ref: this.listRef,
        prefixCls,
        style: style2,
        data: flattenNodes,
