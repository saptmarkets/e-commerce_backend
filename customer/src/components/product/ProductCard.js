...
const ProductCard = ({ product, attributes, promotion }) => {
  ...
  return (
    <>
      ...
      <div className="relative bg-white rounded-lg overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md max-w-sm mx-auto">
        {/* Promotion badge */}
        {promotionInfo && (
          <div className="absolute top-0 left-0 bg-red-600 text-white px-1.5 py-0.5 z-10 text-xs font-medium">
        ...
        <div 
          ...
          className="relative cursor-pointer h-52 sm:h-60 overflow-hidden"
        >
          <Image
            ...
            width={350}
            height={350}
            className="object-cover w-full h-full transition duration-200 transform hover:scale-105"
            onError={(e) => {
        ...
        <div className="p-3 sm:p-3.5">
          ...
          <h3 
            onClick={() => setModalOpen(!modalOpen)}
            className="text-xs sm:text-sm font-medium text-gray-700 cursor-pointer hover:text-green-600 transition-colors my-1.5 line-clamp-2 leading-tight"
          >
            ...
            <div className="mb-3">
              <div className="relative">
                <button
                  ...
                  className="w-full p-2 border border-gray-200 rounded-lg text-left bg-gray-50 hover:bg-gray-100 transition-colors text-sm"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <IoChevronDown className={`transition-transform duration-200 ${unitDropdownOpen ? 'rotate-180' : ''}`} />
                  </div>
                </button>
                  ...
                  <div className="absolute top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-10 max-h-48 overflow-y-auto">
                    {availableUnits.map((unit) => (
                      <button
                        ...
                        className="w-full p-2 text-left hover:bg-gray-50 border-b border-gray-100 last:border-b-0 text-sm"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <span className="font-medium">
            ...
            {availableStock > 0 ? (
              <div className="flex items-center space-x-1">
                <span className="text-xs text-green-600 font-medium">
                  {availableStock} {selectedUnit ? getUnitDisplayName(selectedUnit).toLowerCase() : tr('units','وحدة')} {tr('available','متاحة')}
                </span>
                {packInfo && (
