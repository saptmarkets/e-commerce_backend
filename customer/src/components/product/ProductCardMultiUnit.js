            ...
            <div className="relative">
              ...
              >
                <span className="font-medium">
                  {selectedUnit ? getUnitDisplayName(selectedUnit) : 'Select Unit'}
                </span>
          ...
          {availableStock > 0 ? (
            <div className="flex items-center space-x-2">
              <span className="text-sm font-medium text-green-600">
                In Stock ({availableStock} {selectedUnit ? getUnitDisplayName(selectedUnit).toLowerCase() : 'units'} available)
              </span>
