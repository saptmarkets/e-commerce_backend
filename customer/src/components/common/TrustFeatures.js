...
const TrustFeatures = ({ title, description, features: propFeatures }) => {
  ...
  const getFeatureIcon = (index) => {
    const iconMap = [
      ...
      <FaMobile className="text-3xl text-indigo-600" />
    ];
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-gray-50 p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition duration-300">
