...
>
 ...
 <h2>Hello ${option.name}</h2>
    ...
    option.cname
     ...
     <p style="margin:0px auto; margin-top:40px; text-align:center;">Thank you   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">saptmarkets Team</p></p>
