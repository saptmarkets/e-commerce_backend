...
const readyToParentAndChildrenCategory = (categories, parentId = null) => {
  ...
  let Categories;
  if (parentId == null) {
    // Filter for top-level categories (no parentId, null, empty string, or undefined)
    ...
    // Filter for categories with specific parentId
    Categories = categories.filter((cat) => 
      cat.parentId === parentId || 
      cat.parentId === parentId.toString()
    );
  }
