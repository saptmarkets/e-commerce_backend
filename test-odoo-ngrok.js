...
async function testOdooNgrokConnection() {
  console.log('🧪 Testing Odoo Connection via ngrok...\n');
  ...
  try {
    ...
    // Test 5: Test category fetch
    console.log('\n5️⃣ Testing category fetch...');
    ...
    console.log(`   Category Access: ✅ Working`);
